...
Window {
    ...
    function moveCraft(speedX, speedY){
        ...
        Button {
            ...
            onClicked: {
                ...
                if (start.text=="Restart"){
                    //resetting the values if player want to Restart
                    scoreA=0
                    lifeLeft=5
                    levelInt=1
                    levelUp=0
   ...
   Connections
   {
       ...
       onSomeSignal_tbox1:
       {
          // To access signal parameter, name the parameter
           ...
           speedX = (parseInt(text_tbox1)-1.69)/1.69
           moveCraft(speedX, speedY)
           console.log(speedX)
       ...
       onSomeSignal_tbox2:
       {
          // To access signal parameter, name the parameter
           ...
           speedY = (parseInt(text_tbox2)-1.69)/1.69
           moveCraft(speedX, speedY)
           console.log(speedY)
